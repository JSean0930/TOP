...
class CarControllerParams:
  ACCEL_MAX = 1.75  # m/s2, lower than allowed 2.0 m/s2 for tuning reasons
  ACCEL_MAX_PLUS = 1.7
  ACCEL_MIN = -3.5  # m/s2
...
class CAR(Platforms):
  ...
  TOYOTA_COROLLA_TSS2 = ToyotaTSS2PlatformConfig(
    ...
    CarSpecs(mass=3396. * CV.LB_TO_KG, wheelbase=2.64, steerRatio=13.7, tireStiffnessFactor=0.644),
  )
