...
A_CRUISE_MAX_VALS_DF =     [1.19, 2.04, 2.04, 2.04, 1.3,  1.05,  .75,   .55,  .374, .247, .0714]   ##  [1.4, 2.4, 2.4, 2.4, 1.53, 1.23, .88, .65, .44, .29, .084]  # Sets the limits of the planner accel, PID may exceed
